...
//[KB62] ===> BugID#645 : Froyo porting : wakelock log, added by Jimmy@CCI
...
//[KB62] ===> BugID#932 : add new suspend state for identifying device booting, added by Jimmy@CCI
#ifdef CONFIG_CCI_PM_LOG
...
//[KB62] ===> BugID#798 : refine wakelock log, modified by Jimmy@CCI
...
//[KB62] ===> BugID#976 : refine wakelock log 2, modified by Jimmy@CCI
#ifdef CONFIG_CCI_PM_LOG
...
//[KB62] ===> BugID#976 : refine wakelock log 2, modified by Jimmy@CCI
	...
	unsigned long irqflags;
	spin_lock_irqsave(&list_lock, irqflags);
	if(get_suspend_state() == PM_SUSPEND_MEM && (current_kernel_time().tv_sec - last_dump_timestamp.tv_sec) / cci_pm_active_wakelock_log_period >= 1)
	{
...
//[KB62] ===> BugID#645 : Froyo porting : wakelock log, added by Jimmy@CCI
#ifdef CONFIG_CCI_PM_LOG
	if (ret && (debug_mask & DEBUG_SUSPEND) && type == WAKE_LOCK_SUSPEND && get_suspend_state() == PM_SUSPEND_MEM)
#else // #ifdef CONFIG_CCI_PM_LOG
