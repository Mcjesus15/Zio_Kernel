...
#endif
//[KB62] ===> BugID#645 : Froyo porting : timestamp for kernel log, added by Jimmy@CCI
...
asmlinkage int vprintk(const char *fmt, va_list args)
{
	...
	for ( ; *p; p++) {
		if (new_text_line) {
                        // Luke 2010.0916,  Bugzilla #648, K log,  Froyo Startup porting
                        #ifdef CONFIG_CCI_KLOG_COLLECTOR
			/* Kevin_Chiang@CCI: Add Epoch Time to align with other Andorid Log for easy time tracing */
			...
			new_text_line = 0;
                        // Luke 2010.0916,  Bugzilla #648, K log,  Froyo Startup porting
                        #ifdef CONFIG_CCI_KLOG_COLLECTOR  // [S] WF 2010-05-11 KB62_CR#107
			cklc_append_kernel_raw_char('<');
			cklc_append_kernel_raw_char(current_log_level + '0');
			cklc_append_kernel_raw_char('>');
                        #endif // [E] WF 2010-05-11 KB62_CR#107
