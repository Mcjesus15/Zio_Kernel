...
/*B [Bug968] Audio drop out due to low ARM performance (PCMDMAMISSED), CCI 2010/11/04*/
//#define BUFSZ (960 * 5)
#define BUFSZ (960 * 10)
/*E [Bug968] Audio drop out due to low ARM performance (PCMDMAMISSED), CCI 2010/11/04*/
...
extern int speaker_audmgr_enable(bool on);
#endif
