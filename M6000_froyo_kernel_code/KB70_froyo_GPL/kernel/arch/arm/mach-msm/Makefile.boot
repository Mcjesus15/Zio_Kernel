...
# MSM7x27
ifeq ($(CONFIG_DDR_RAM_TWO_DIE), y)
   zreladdr-$(CONFIG_ARCH_MSM7X27)      := 0x18408000
params_phys-$(CONFIG_ARCH_MSM7X27)      := 0x18400100
initrd_phys-$(CONFIG_ARCH_MSM7X27)      := 0x22200000
else
   zreladdr-$(CONFIG_ARCH_MSM7X27)      := 0x00408000
params_phys-$(CONFIG_ARCH_MSM7X27)      := 0x00400100
initrd_phys-$(CONFIG_ARCH_MSM7X27)      := 0x0A200000
endif # CONFIG_DDR_RAM_TWO_DIE
