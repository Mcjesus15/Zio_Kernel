...
static bool off_reason = false;
static unsigned off_data[2] = {0,0};
...
//[KB62] ===> BugID#645 : Froyo porting : power off reason support, added by Jimmy@CCI
#ifdef CONFIG_CCI_POWER_OFF_REASON_SUPPORT
void (*pm_power_off)(unsigned data1, unsigned data2);
...
//[KB62] ===> BugID#645 : Froyo porting : power off reason support, added by Jimmy@CCI
#ifdef CONFIG_CCI_POWER_OFF_REASON_SUPPORT
void machine_power_off_reason(unsigned data1, unsigned data2)
{
	off_reason = true;
	off_data[0] = data1;
	off_data[1] = data2;
...
//[KB62] ===> BugID#645 : Froyo porting : power off reason support, added by Jimmy@CCI
#ifdef CONFIG_CCI_POWER_OFF_REASON_SUPPORT
	{
		if (off_reason)
		{
			pm_power_off(off_data[0], off_data[1]);
		}
		else
		{
			pm_power_off(0,0);
